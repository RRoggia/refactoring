...
const aBooking = createBooking( { price: 30 }, new Date() )
const aPremiumBooking = createPremiumBooking( { price: 30, talkback: true }, new Date(), { premiumFee: 30 } )
